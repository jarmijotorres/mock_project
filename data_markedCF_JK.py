...
if rank == 0:
    ...
    np.save('/cosma7/data/dp004/dc-armi2/HOD_mocks/observables/markedclustering/JKs/all_MCF_JK25_'+cat_name+'_logrp%.1lf_%.1lf_%dbins_pimax%d_%dpibins.npy'%(sigma[0],sigma[-1],nsi,pimax,npi),wp_JK_all)
    ...
    #G1_vols_all /= d_box**2
    np.savetxt('/cosma7/data/dp004/dc-armi2/HOD_mocks/observables/markedclustering/JK25_MCF_'+cat_name+'_logrp%.1lf_%.1lf_%dbins_pimax%d_%dpibins.txt'%(sigma[0],sigma[-1],nsi,pimax,npi),S)